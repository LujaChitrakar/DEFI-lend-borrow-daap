...
const Container = (props) => {
  ...
  return (
    ...
    <div className="overflow-y-auto h-full w-full py-1">
    {/* <div className='sticky top-[-8px] bg-gray-400 p-2 text-xl text-center'>
    {props.name}
</div> */}
          ...
          <tbody className="divide-y divide-gray-700">
            {props.data.map((item, index) => (
              ...
              >
               ...
               {props?.label && <td className="px-6 py-4"> 
                <button onClick={()=>{setOpenModalScreen(props?.label)}} class=" inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:focus:ring-cyan-800">
<span class=" px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-transparent group-hover:dark:bg-transparent hover:text-black">
{props?.label}
</span>
</button>
                </td>}
